...
\begin{tikzpicture}
    % Base
    \draw  (0.5,1.5) -- (0,1.5) -- (0,0) -- (5,0) -- (5,1.5) -- (4.5,1.5);
    \fill[black] (0.35,1.5) rectangle (0.5,1.25);
    \fill[black] (4.5,1.5) rectangle (4.65,1.25);
    \draw (0.35,1.25) -- (4.65,1.25);
    % Electronics
    \draw (2.5,0) circle (0.5);
    \draw[->] (2,0.7) -- (3,0.7) node[midway, above] {\scriptsize E \normalsize}; 
    \node (+) at (3.25, -0.25) {+};
    \node (-) at (1.75, -0.25) {$-$};
    % Support
    \draw (1,1.25) -- (1.5,2.25) -- (3.5,2.25) -- (4,1.25);
    % Water
    \path[fill=blue!30, even odd rule] (0.625,3.1875) -- (1,2.25) -- (4,2.25) -- (4.375,3.1875) 
    -- (3.5,3.1875) -- (3.5,4.25) -- (3,4.25) -- (3,3.1875) 
    -- (2,3.1875) -- (2,3.75) -- (1.5,3.75) -- (1.5,3.1875) -- cycle; 
    % Container
    \draw (0.5, 3.5) -- (1,2.25) -- (4,2.25) -- (4.5,3.5);
    % Test Tubes
    \draw[thick] (1.5,2.5) -- (1.5,4.5) (2,4.5) arc(0:180:0.25) (2,4.5) -- (2,2.5);
    \draw[thick] (3,2.5) -- (3,4.5) (3.5,4.5) arc(0:180:0.25) (3.5,4.5) -- (3.5,2.5);
    % Electrodes 
    \fill[black] (5/3,3) rectangle (11/6,2.25);
    \fill[black] (19/6,3) rectangle (10/3,2.25);
    % Bubbles Tube 1
    \path[draw, fill=white] (1.59, 2.63) circle (0.025);
    \path[draw, fill=white] (1.9, 2.75) circle (0.025);
    \path[draw, fill=white] (1.62, 3.03) circle (0.025);
    \path[draw, fill=white] (1.7, 3.1) circle (0.025);
    \path[draw, fill=white] (1.75, 3.05) circle (0.025);
    \path[draw, fill=white] (1.78, 3.15) circle (0.025);
    \path[draw, fill=white] (1.75, 3.25) circle (0.025);
    \path[draw, fill=white] (1.63, 3.3) circle (0.025);
    \path[draw, fill=white] (1.88, 3.27) circle (0.025);
    \path[draw, fill=white] (1.68, 3.4) circle (0.025);
    \path[draw, fill=white] (1.78, 3.35) circle (0.025);
    \path[draw, fill=white] (1.786, 3.5) circle (0.025);
    \path[draw, fill=white] (1.6, 3.65) circle (0.025);
    \path[draw, fill=white] (1.75, 3.7) circle (0.025);
    % Bubbles Tube 2 
    \path[draw, fill=white] (3.09, 2.63) circle (0.025);
    \path[draw, fill=white] (3.4, 2.75) circle (0.025);
    \path[draw, fill=white] (3.12, 2.89) circle (0.025);
    \path[draw, fill=white] (3.12, 3.03) circle (0.025);
    \path[draw, fill=white] (3.2, 3.1) circle (0.025);
    \path[draw, fill=white] (3.25, 3.05) circle (0.025);
    \path[draw, fill=white] (3.28, 3.15) circle (0.025);
    \path[draw, fill=white] (3.25, 3.25) circle (0.025);
    \path[draw, fill=white] (3.13, 3.3) circle (0.025);
    \path[draw, fill=white] (3.38, 3.27) circle (0.025);
    \path[draw, fill=white] (3.18, 3.4) circle (0.025);
    \path[draw, fill=white] (3.28, 3.35) circle (0.025);
    \path[draw, fill=white] (3.286, 3.5) circle (0.025);
    \path[draw, fill=white] (3.42, 3.58) circle (0.025);
    \path[draw, fill=white] (3.1, 3.65) circle (0.025);
    \path[draw, fill=white] (3.25, 3.7) circle (0.025);
    \path[draw, fill=white] (3.2, 3.8) circle (0.025);
    \path[draw, fill=white] (3.34, 3.85) circle (0.025);
    \path[draw, fill=white] (3.125, 4) circle (0.025);
    \path[draw, fill=white] (3.38, 4.1) circle (0.025);
    % Electrons et courant
    \draw (0.15, 1) -- (0,1.2) -- (-0.15,1) node[left, yshift=0.15cm] {\scriptsize $e^-$ \normalsize};
    \draw (0.15, 0.6) -- (0,0.4) -- (-0.15,0.6) node[left, yshift = -0.08cm] {\scriptsize $I$ \normalsize};
    \draw (4.85, 1) -- (5,1.2) -- (5.15,1) node[right, yshift=0.08cm] {\scriptsize $I$ \normalsize};
    \draw (4.85, 0.6) -- (5,0.4) -- (5.15,0.6) node[right, yshift = -0.08cm] {\scriptsize $e^-$ \normalsize};
    % Fleches
    \draw[<-] (5/3, 2.9) -- (0,2.9) node[left] {\scriptsize Electrode 1 (en platine)\normalsize};
    \draw[<-] (1.6,2.4) -- (0,2.4) node[left, text width= 4cm, yshift = -0.2cm] {\scriptsize Les tubes doivent être 2 à 3 \\ mm au dessus du fond.};
    \draw[<-] (10/3,2.4) -- (5,2.4) node[right] {\scriptsize Electrode 2 (en platine)\normalsize};
    \draw[<-] (3.75,3) -- (5,3) node[right, text width = 4cm, yshift=0.2cm] {\scriptsize 70 mL d'acide sulfurique $(2 \text{H}^+; \text{SO}_4^{2+})$ à 1 $\si{mol.L^{-1}}$ \normalsize};
    \draw[<-] (1.65,4.15) -- (0,4.15) node[left] {\scriptsize $V_{H_2} = 21 \si{mL}$ \normalsize};
    \draw[<-] (3.3,4.5) -- (5,4.5) node[right] {\scriptsize $V_{O_2} = 10,5 \si{mL}$ \normalsize};
\end{tikzpicture}
\end{center}
